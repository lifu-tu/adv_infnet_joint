		...
		"""
	        ...
	        """
                ...
                if (params.regu_type ==0):
                      g_cost = T.mean(-hinge_cost0) +  T.mean(ce_hinge)
                else:
                      g_cost = T.mean(-hinge_cost0)
                ...
                d_cost = T.mean(T.maximum(hinge_cost0, 0.0))
        ...
        def train(self, trainX, trainY, devX, devY, testX, testY, params):	
                ...
                try:
                        for eidx in xrange(500):
                                ...
                                print 'after d_step: cost-augmented inf positive', g_aa, ' inf positive', g_bb
                                print 'after g_step: cost-augmented inf positive', aa, ' inf positive', bb
                                end_time1 = time.time()
